...
class FelicaSettingsFragment :
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
         ...
         * /odm/etc/<sku>_build.prop, which is the number on the back of the
        ...
        /*
         * No automatic entry. Nothing the bootloader hands out distinguishes
         * A201XM from 22081212R - both report sku diting/ditingp and product
         * diting - so there is no detection for one to fall back to, and an
         * entry that quietly kept whatever shipped would only hide which set is
         * in use. The property ships with the open market model as its default,
         * so the list always has a selection to show.
         */
